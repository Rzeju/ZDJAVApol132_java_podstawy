...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        //Wywołanie metody statycznej "printNumber()" na utworoznym obiekcie
        ...
        //Wywołanie metodystatycznej i przypisanie zwróconego wyniku do zmiennej 'result'
